...
DCₒ = loadDCₒData("C:/Users/Chris/Projects/SIS/data/dciv.csv"; Vcol = 1, Icol = 2) #loadDCₒData("C:\\Users\\Chris\\OneDrive\\Project\\IV curves data\\Unpumped_offset_corrected.csv");

DC = loadDCData("C:/Users/Chris/Projects/SIS/data/f230.csv", DCₒ; ν = 230.0, Vcol = 1, Icol = 2)#("C:\\Users\\Chris\\OneDrive\\Project\\IV curves data\\Pumped_offset_corrected.csv", DCₒ; ν = 230.0)

#=
# perform impedance recovery=#
fitVs, fitIs = File.filter(DC.nVs, DC.nIs, 0.75, 0.95);
